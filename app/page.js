...
const METRICS = {
  ...
  'Blood Glucose':{datatypeCategory:'Continuous data',unit:'mg/dL',y0:40,yMax:400,dynamicBounds:true,integerOnly:true,goal:100,goalLabel:'Normal <100',
    zones:[{upper:70,l:'Hypoglycemia'},{upper:100,l:'Normal (Fasting)'},{upper:126,l:'Pre-diabetic'},{upper:140,l:'Normal (Post-meal)'},{upper:200,l:'Impaired Glucose Tolerance'},{upper:Infinity,l:'Diabetic Range'}],
    tf:{
      D:{labels:['Fasting','Post-B','Post-L','Post-D'],data:[92,145,130,118],agg:'Per reading'},
      W:{labels:['Sun','Mon','Tue','Wed','Thu','Fri','Sat'],data:[94,96,92,100,98,95,93],agg:'Fasting daily'},
      M:{labels:['Wk1','Wk2','Wk3','Wk4'],data:[95,97,93,96],agg:'Weekly avg'},
      Y:{labels:['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'],data:[98,96,95,94,93,92,91,92,94,95,97,99],agg:'Monthly avg'},
    }},
